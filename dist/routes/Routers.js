...
const Routers = [
    ...
    { url: '/deleteUser/:id', method: 'delete', callBack: UserController_1.default.delete, securityLevel: 3 },
    ...
    { url: '/user/search', method: 'post', callBack: UserController_1.default.search, securityLevel: 3 },
];
